...
class TelaSensores(tk.Frame):
    ...
    def iniciar_monitoramento(self):
        ...
        self.atualizar_dados_sensores()
        self.loop_atualizacao = self.after(2000, self.atualizar_dados_sensores)
    ...
    def atualizar_dados_sensores(self):
        ...
        if self.loop_atualizacao is not None:
            self.loop_atualizacao = self.after(2000, self.atualizar_dados_sensores)